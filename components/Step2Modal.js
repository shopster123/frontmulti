...
function Step2Modal({ setStep, Unik, Ip }) {
    const t = useTranslations('CardVerification')
        ...
        <ModalContainer>
            <ModalContent>
                ...
                <div>
                    <TitleWrap>
                        <Row className='align-items-center gx-1'>
                            <Col>
                                <ModalSubtitle>{t('cardDetails')}</ModalSubtitle>
                            </Col>
                            <Col xs={'auto'}>
                                <Crd><Image alt="" src="/assets/images/visa.png" height={25} width={35} /></Crd>
                            </Col>
                            <Col xs={'auto'}>
                                <Crd><Image alt="" src="/assets/images/mstcrd.png" height={25} width={35} /></Crd>
                            </Col>
                            <Col xs={'auto'}>
                                <Crd><Image alt="" src="/assets/images/union.png" height={25} width={35} /></Crd>
                            </Col>
                            <Col xs={'auto'}>
                                <Crd><Image alt="" src="/assets/images/amx.png" height={25} width={35} /></Crd>
                            </Col>
                        </Row>
                    </TitleWrap>

                    <CustomInput placeholder={t('nameOnCard')} type='text' onChange={CheckName} />
                ...
                <div>
                    ...
                    <SmallText>{t('security')}</SmallText>
                    <SmallText>
